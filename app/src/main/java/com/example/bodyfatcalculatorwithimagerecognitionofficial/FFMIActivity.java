...
public class FFMIActivity extends AppCompatActivity {
    Button button;

    android.widget.Button mcalculateffmi;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_ffmiactivity);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(FFMIActivity.this,MainActivity.class);
        ...
        mcalculateffmi=findViewById(R.id.calculateffmi);
        ...
        mcalculateffmi.setOnClickListener(v -> {
            ...
            if(typeofuser.equals("0"))
            {
                ...
                Intent intent = new Intent(FFMIActivity.this, FFMIResult.class);
                intent.putExtra("gender", typeofuser);
                intent.putExtra("height", mintprogress);
                intent.putExtra("weight", weight2);
                intent.putExtra("age", age2);
                Log.e("height",mintprogress);
                Log.e("weight",mintprogress);
                startActivity(intent);
            }
        });
    }
